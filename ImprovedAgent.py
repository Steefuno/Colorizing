...
patch_width = 5  # Width and height of patch to match testing data with training data
assert (patch_width % 2 == 1)


class ImprovedAgent(Agent.Agent):
    ...
    def run(self):
        ...
        for test_pixel_id in range(0, num_pixels, 1):
            ...
            print(
                "Predicted Pixel ({} of {}) at t={:.2f} seconds".format(test_pixel_id, num_pixels, time() - start_time))
...
if __name__ == "__main__":
    ...
    Agent.save_all([agent.training_image, image], "Output/Improved Agent Prediction.png")